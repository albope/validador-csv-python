...
import tkinter as tk # <-- CORRECCIÓN: Re-añadido para las constantes del Treeview
...
class ValidadorCSVApp:
    def __init__(self, root):
        ...
        # Configurar el estilo del Treeview para que coincida con los temas
        self._configure_treeview_style()
        # Crear todos los widgets de la aplicación
        self._crear_widgets()
        # Actualizar el estilo del Treeview al tema inicial
    ...
    def _configure_treeview_style(self):
        """Configura el estilo base del ttk.Treeview."""
        self.style = ttk.Style()
        # El tema 'clam' es más fácil de personalizar que 'default'
        self.style.theme_use("clam")
        
    def _update_treeview_theme(self, mode):
        """Actualiza los colores del Treeview para que coincidan con el tema de la App."""
        logger.info(f"Actualizando el tema del Treeview a: {mode}")
        # Capitalizamos para asegurar consistencia (ej. "light" -> "Light")
    ...
    def _crear_widgets(self):
        ...
        # --- Fila de Título y Selector de Tema ---
    ...
    def change_appearance_mode_event(self, new_appearance_mode: str):
        """Cambia el tema de la aplicación y actualiza el estilo del Treeview."""
    ...
    def _sort_treeview_column(self, col, reverse):
        try:
            ...
            if col == 'linea':
                try:
                    # Ordena numéricamente pero pone los guiones ('-') al final
    ...
    def _exportar_informe(self):
        ...
        # --- CORRECCIÓN: Bloque try/except completo ---
        try:
